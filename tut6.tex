...
\section{Orga}
	\begin{frame}
		...
		\begin{block}{Klausur, Übungsschein}
			\begin{itemize}
				\item Hauptklausur: 26. Juli 2018, 15:00 Uhr
				\item Nachklausur: findet am 08.10 statt
...
\end{frame}
	...
	\begin{frame}
		\frametitle{Häufige Fehler}
		\begin{block}{Aufgabe 2: Parallelisierung von Shutterpile}
			\begin{itemize}
				\pause 
				\item %TODO
			\end{itemize}
	...
	\begin{frame}
		\frametitle{Häufige Fehler}
		\begin{block}{Aufgabe 4: Parallelisierungswettbewerb}
			\begin{itemize}
				%TODO
				\pause
