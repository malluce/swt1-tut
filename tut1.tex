...
\section{UML-Klassendiagramm}
	...
	\begin{frame}
		...
		\begin{small}
			\begin{itemize}
				\item - ist private: von Instanzen derselben Klasse sichtbar (aber von allen!)
			\end{itemize}
		\end{small}
	\end{frame}
	...
	\begin{frame}
		...
		\end{figure}
		\centering Kursiv schriftlich nicht erkennbar!
	\end{frame}
	...
	\begin{frame}
		...
		\begin{figure}
			\subfigure[Aggregation]{\includegraphics[scale=0.5]{./pics/tut1/aggregation.png}}	
			\subfigure[Komposition]{\includegraphics[scale=0.5]{./pics/tut1/composition.png}}
		\end{figure}
	\end{frame}
	...
	\begin{frame}
		...
		\begin{itemize}
			...
			\begin{itemize}
				...
				\item für einfache Textdokumente anfangs umständlich
			\end{itemize}
		\end{itemize}
	\end{frame}
