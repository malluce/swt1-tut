	...
	\begin{frame}[fragile]
		...
		\begin{itemize}
			...
			\item Aufgaben von Maven
				...
				\end{itemize}
			\item Goals = Maven-Befehle (z.B. mvn package)
				\begin{itemize}			
					\item Ausführung eines Goals führt ggf. vorandgehende Goals aus
					\item \url{https://maven.apache.org/guides/introduction/introduction-to-the-lifecycle.html}
					%TODO wasserfall 
				\end{itemize}
		\end{itemize}
\end{frame}
